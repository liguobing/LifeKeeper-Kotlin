...
public class JZMediaExoKernel extends JZMediaInterface implements Player.EventListener, VideoListener {
    private SimpleExoPlayer simpleExoPlayer;
    private Runnable callback;
    private long previousSeek = 0;

    public JZMediaExoKernel(Jzvd jzvd) {
        super(jzvd);
    }
    ...
    public void prepare() {
        ...
        mMediaHandler.post(() -> {
            ...
            simpleExoPlayer = new SimpleExoPlayer.Builder(context, renderersFactory)
                    ...
                    .build();
            DataSource.Factory dataSourceFactory = new PlayVideoDataSource(context).getDataSourceFactory();
